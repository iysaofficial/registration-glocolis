  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Global Competition for Life Sciences - Online Competition":
        ...
        break;
      case "Global Competition for Life Sciences - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$200 USD");
        break;
      case "Global Competition for Life Sciences - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
              ...
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="Global Competition for Life Sciences - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Global Competition for Life Sciences - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
